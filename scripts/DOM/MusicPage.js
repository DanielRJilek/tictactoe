class MusicPage {
    ...
    async createSlides(content) {
        ...
        let slideImages = (await this.getFileContent("./assets/music_slide_images.txt")).split("\n");
        let captions = (await this.getFileContent("./assets/music_slide_captions.txt")).split("\n");
    ...
    async createAboutText(content) {
        let text = await this.getFileContent("./assets/music.txt");
